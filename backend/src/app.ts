...
import { ahchRequestRouter } from './routes/ahch-request.routes';
import { documentRouter } from './routes/document.routes';
import { documentFolderRouter } from './routes/documentFolder.routes';
...
app.use('/api', ahchRequestRouter);
app.use('/api', documentRouter);
app.use('/api', documentFolderRouter);
